...
function App() {
  return (
    <>
      <div className="m-0 flex p-24 w-full h-auto justify-center">
        <div className="flex">
          <h1 className=" flex-auto flex-wrap text-emerald-100 p-6 bg-center bg-emerald-900 ">
            Bienvenidos{" "}
          </h1>
          <h5 className=" flex-5 text-4xl  text-white-500 bg-emerald-800 center p-3 ">
            React with JS
          </h5>

          <section className="flex flex-nowrap p-8 bg-center">
